    ...
    for root, dirs, files in os.walk(base_dir):
        for file in files:
            ...
            if file_path.endswith(".md"):
                metadata = {'system_doc_id': 950+idx,
                        'app_id': 2,
                        'knowledge_id': 438,
                        'subject': basename,
                        'link': ''}
                embedder.upsert(source=file_path, metadata=metadata)


if __name__ == "__main__":
    # insert_md("E:\project\eip-docs\doc")
    file_path = "C:\\Users\\admin\\Documents\\docs\\03-《新员工入职指引》.pdf"
    # # file_path = "E:\\project\\eip-docs\\doc\\version.md"
    metadata = {'system_doc_id': 1001,
                'app_id': 2,
                'knowledge_id': 438,
                'subject': '新员工入职指引',
                'link': ''}
